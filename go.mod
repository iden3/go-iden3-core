module github.com/iden3/go-iden3
...
require (
	...
	github.com/aristanetworks/goarista v0.0.0-20190604154621-be0489a019a4 // indirect
	github.com/arnaucube/go-snark v0.0.0-20190603164730-7b1a15df7f74
