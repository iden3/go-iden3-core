...
func Test_DIDString(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test poligon did",
			"114vgnnCupQMX4wqUBjg5kUya3zMXfPmKc9HNH4TSE",
			"did:iden3:poligon:test:114vgnnCupQMX4wqUBjg5kUya3zMXfPmKc9HNH4TSE",
			WithNetwork("poligon", "test"),
		},
		{"Test identifier 41 char",
			"11FjRaFUGZA5yBXREaH6P11yezYsxwJLMsEUerTVj",
			"did:iden3:poligon:test:11FjRaFUGZA5yBXREaH6P11yezYsxwJLMsEUerTVj",
			WithNetwork("poligon", "test"),
		},
	}
