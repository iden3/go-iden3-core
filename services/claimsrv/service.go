...
type Service interface {
	...
	GetClaimProofUserByHi(ethAddr common.Address, hi *merkletree.Hash) (*core.ProofOfClaim, error)
...
func (cs *ServiceImpl) GetClaimProofUserByHi(ethAddr common.Address,
