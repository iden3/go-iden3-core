...
func TestClaimAssignName(t *testing.T) {
	...
	assert.Equal(t,
		...
		e.HIndex().Hex())
	assert.Equal(t,
		"0x122311e315a8bbfb0e48bbdaf72b21df48fa633d72a0bb4b66f0260e002e1b36",
		e.HValue().Hex())
	dataTestOutput(&e.Data)
	assert.Equal(t, ""+
...
func TestClaimAuthorizeKSign(t *testing.T) {
	...
	e := c0.Entry()
	assert.Equal(t,
		"0x00a812462a3dbb7e6592587a242616ab61fd53236b470f0c143cd63ee59249b3",
		e.HIndex().Hex())
	assert.Equal(t,
...
func TestClaimSetRootKey(t *testing.T) {
	...
	e := c0.Entry()
	assert.Equal(t,
		"0x15ba36cafcc2944ec4aa903eecab3f6902fa896125d0676ae7a4cfdb5932970d",
		e.HIndex().Hex())
	assert.Equal(t,
...
func TestClaimLinkObjectIdentity(t *testing.T) {
	...
	entry := claim.Entry()
	assert.Equal(t,
		"0x0315eb5ebd41e0c8a96f24eea69364dd26fe0eca5d41992e9954a3c170af0272",
		entry.HIndex().Hex())
	assert.Equal(t,
		"0x2b26f24ff8ffd67b98742c8e4c8f34b778ed32c9ab5fe97babe3ec4b5d7e80a5",
		entry.HValue().Hex())
